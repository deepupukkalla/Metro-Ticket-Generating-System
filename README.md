...
Project Phases
Ideation Phase — Brainstorming, problem statement, and empathy mapping for metro commuters
Project Design Phase — Solution fit, proposed solution, solution requirements, and solution architecture
Project Planning Phase — Product backlog, sprint planning, and story point estimation
Project Development Phase — Building the Service Catalog item, Flow, database table, and notifications
Acceptance Testing Phase — UAT execution, defect analysis, and test case reporting
Installation & Setup
Prerequisites
...
Search for or navigate to "Book A Metro Ticket" in the Service Catalog
Select Book QR Ticket
Enter Passenger Name, Email Address, Travel Date, Starting From, Going To stations, Journey Type, and Number of Passengers
Review the auto-calculated fare (Amount for Single Journey / Amount Including Return)
Click Order Now
Receive the Request Summary (REQ) and track it under My Requests
Receive an email with the Ticket ID and QR code for boarding
Recharging a Metro Card
Navigate to "Book A Metro Ticket" and select Recharge Metro Card
Enter Smart Card Holder Name, Smart Card Number, and Recharge Amount
Select Mode of Payment (UPI/Credit Card/Debit Card/Other)
Enter Email Address and click Order Now
Tracking a Request
...
For platform-level APIs, refer to the ServiceNow Developer Documentation
Testing
